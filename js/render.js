        ...
        <article class="entry" id="entry-${escapeHtml(entry.id)}" data-entry-id="${escapeHtml(entry.id)}">
          <div class="bubble">
            ...
            <div class="entry-actions">
              ...
              <a class="icon-btn" href="./admin/#/collections/posts/entries/${escapeHtml(entry.id)}" target="_blank" aria-label="編集">
                <svg viewBox="0 0 24 24">
              ...
              <a class="icon-btn is-danger" href="./admin/#/collections/posts/entries/${escapeHtml(entry.id)}" target="_blank" aria-label="削除">
                <svg viewBox="0 0 24 24">
